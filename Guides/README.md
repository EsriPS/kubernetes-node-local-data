...
See also [NodeLocalDataStores](https://github.com/Esri/arcgis-enterprise-on-kubernetes-resources/tree/main/NodeLocalDataStores) for staging large file-based datasets onto node-local storage for routing and geocoding services.
